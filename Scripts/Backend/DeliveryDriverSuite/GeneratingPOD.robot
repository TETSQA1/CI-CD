...
Verify that the POD is generated after the parcel delivered to the customer
    ...
    #Generating the POD
    Generate the POD for the parcel delivered to the customer    ${driver_token}    ${parcel_id}